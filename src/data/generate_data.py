...
# Define helper functions to generate simulated data
...
df = df.round(3)
output_path = "C:/Users/adagi/onedrive/Python Development/bigproject/data/raw/simulated_data.csv"
df.to_csv(output_path, index=False)
print(f"Simulated data generated and written to {output_path}")
